...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Customizable = __webpack_require__(161);
	
	var _Customizable2 = _interopRequireDefault(_Customizable);
	
	var _UndoRedo = __webpack_require__(162);
	
	var _UndoRedo2 = _interopRequireDefault(_UndoRedo);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var section = { marginBottom: 40 };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controllable = _react2.default.createClass({
	  ...
	  onChangeDebounced: function onChangeDebounced(_ref) {
	    var value = _ref.target.value;
	
	    this.setState({ debouncedValue: value, value: value });
	  },
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      'Contollable input',
	      _react2.default.createElement('input', { type: 'text', value: this.state.value, onChange: this.onChange }),
	      _react2.default.createElement(
	        'p',
	        null,
	        'Value: ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Customizable = _react2.default.createClass({
	  ...
	  onChangeMinLength: function onChangeMinLength(_ref2) {
	    var value = _ref2.target.value;
	
	    this.setState({ minLength: parseInt(value, 10) });
	  },
	  onChangeIndefiniteTimeout: function onChangeIndefiniteTimeout(_ref3) {
	    var checked = _ref3.target.checked;
	
	    this.setState({ indefinite: checked });
	  },
	  onChangeForceByEnter: function onChangeForceByEnter(_ref4) {
	  ...
	  render: function render() {
	    ...
	    var indefinite = _state.indefinite;
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        minLength,
	        ']: ',
	        _react2.default.createElement('input', { type: 'range', step: 1, min: 0, max: 10,
	      ...
	      _react2.default.createElement(
	        ...
	        debounceTimeout,
	        'ms]: ',
	        _react2.default.createElement('input', { disabled: indefinite, type: 'range', step: 100, min: 0, max: 1000,
